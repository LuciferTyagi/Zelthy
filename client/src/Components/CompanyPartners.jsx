...
const CompanyPartners = () => {
  return (
    ...
    <div className='Comapnies-Partner-Wrapper container mx-auto md:w-[1440px] flex flex-col bg--700 gap-18   '>
        ...
        <div className="marquee-container bg--300 overflow-hidden flex flex-col gap-16 mt-5">
      <Marquee gradient={true} speed={50} direction='right '>
        {companyLogos.slice(0,5).map((logo) => (
          <img
            ...
            src={logo.src}
            alt={logo.name}
            className="company-logo w-25 md:w-48 object-contain mr-20 md:mr-36"
          />
        ))}
      </Marquee>
      <Marquee gradient={true} speed={50} direction="left">
        {companyLogos.slice(5).map((logo) => (
          <img
            ...
            src={logo.src}
            alt={logo.name}
            className="company-logo w-25 md:w-48 object-contain mr-36"
          />
        ))}
      </Marquee>
    </div>
