...
const SignUp = () => (
  <section className="relative SignUp-Section w-full h-auto lg:h-screen font-[inter] bg-transparent dark:bg-transparent flex flex-col">
    ...
    <div className="Container w-full max-w-[1440px] mx-auto h-full flex flex-col gap-10 lg:grid lg:grid-cols-2 lg:gap-20 xl:gap-32 lg:items-center py-10 px-4 lg:py-0 md:px-0">
      <AuthCard
        title="Sign up for your Zelthy Slot account"
        subtitle="Always free! No credit card required."
        buttonText="Sign up"
        redirectText="Welcome back!"
        redirectLink="Log in"
        redirectHref="/log-in"
        isLogin={false}
      />
      ...
      <div className="Sign-Up-Introduction sm:max-w-[600px] lg:max-w-full mx-auto flex flex-col gap-3 md:gap-5">
        <h1 className="text-3xl md:text-4xl text-[#0B3558] dark:text-white font-bold">
          Create your free account
        </h1>
        <p className="text-sn md:text-lg text-[#476788] dark:text-[#B0B0B0]">
          Seamlessly manage your availability and book slots with ease!
          Configure your schedule, view available times, and stay in sync—all in
          one intuitive platform.
        </p>
        <h3 className="text-xl md:text-3xl text-[#0B3558] dark:text-white font-semibold">
          Why Zelthy Slot?
        </h3>
