  ...
  return (
    <div className='bg--300 w-full h-full '>
          <div className='Introduction flex flex-col gap-4'>
                <h1 className='text-5xl font-bold text-blue-500 dark:text-white'>Zelthy Slot</h1>
                <p className='text-lg text-zinc-500 dark:text-[#B0B0B0] font-medium'>Zelthy Slot – A seamless and efficient slot booking platform that lets users set their availability and schedule appointments effortlessly across different <span className='text-blue-500'>time zones</span></p>
          ...
          <div className='Why-Zelthy-Slot flex flex-col gap-4 mt-8'>
               <h1 className='text-4xl font-bold text-blue-500 dark:text-white'>Why Zelthy Slot?</h1>
