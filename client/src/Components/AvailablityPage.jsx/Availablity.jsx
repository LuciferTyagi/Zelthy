...
const applyCopiedTime = () => {
  ...
  return (
    <div>
      <h1 className='text-5xl font-bold text-[#0A2540]'>Availablity</h1>
      <div className='flex flex-col gap-4 mt-10'>
      {daysOfWeek.map((day) =>(
        <div className='flex items-center gap-4 '>
         <p className='text-lg text-[#476788] font-medium w-32 bg--500'>{day}</p>
         {availability[day].isAvailable ? (
              <>
                ...
                <img src="/images/close.png" alt="close" className="size-4 mx-4 cursor-pointer" onClick={() => handleToggleAvailability(day)} />
