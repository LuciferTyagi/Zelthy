...
const Dashboard = ({setTabSelected }) => {
    ...
    return (
        <div className="Dashboard-Wrapper w-full h-full bg--300">
            <h1 className="text-5xl text-blue-500 font-bold dark:text-white">Dashboard</h1>
            <p className="text-lg text-zinc-500 font-medium mt-4 dark:text-[#B0B0B0]">Welcome to your Dashboard! Manage your profile, update availability, and stay organized—all in one place</p>
            <div className="w-full bg--300 flex  gap-10 py-20">
                 ...
                 <div className="Availablity-User   h-fit grid grid-cols-3 gap-6">
